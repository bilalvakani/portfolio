...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border">
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                <a href="#home" className="text-xl font-bold text-primary relative z-50">
                    <span className="text-primary">Bilal</span>
                    <span className="text-primary/70">Vakani</span>
                </a>
            ...
            {/* Mobile menu */}
            {mobileMenuOpen && (
                <div className="md:hidden bg-background/80 backdrop-blur-md border-t border-border px-4 py-4">
